...
import { AtlasTextureDescriptor, MTOON_TEXTURE_SLOTS, MToonTextureSlot, OptimizationError, PatternMaterialMapping, TextureCombinationPattern, ThreeImageType } from "../types"
 ...
 */
export function pack(patternMappings: PatternMaterialMapping[]): ResultAsync<PackingLayouts, OptimizationError>
{
 ...
 */
export function extractTexturePattern(material: MToonMaterial): TextureCombinationPattern
{
